 ...
 *       &lt;sequence&gt;
 *         &lt;element name="instnr" type="{https://uni-login.dk}Regnr"/&gt;
 *         &lt;choice&gt;
 *           &lt;element name="elev" type="{https://uni-login.dk}InstitutionstilknytningElev"/&gt;
 *           &lt;element name="ansat" type="{https://uni-login.dk}InstitutionstilknytningAnsat"/&gt;
 *           &lt;element name="ekstern" type="{https://uni-login.dk}InstitutionstilknytningEkstern"/&gt;
 *           &lt;element name="kontakt" type="{https://uni-login.dk}InstitutionstilknytningKontakt"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
