 ...
 *         &lt;choice&gt;
 *           &lt;element name="elev" type="{https://uni-login.dk}BrugertilknytningElev"/&gt;
 *           &lt;element name="ansat" type="{https://uni-login.dk}BrugertilknytningAnsat"/&gt;
 *           &lt;element name="ekstern" type="{https://uni-login.dk}BrugertilknytningEkstern"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
