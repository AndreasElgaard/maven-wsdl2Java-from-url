 ...
 *         &lt;choice&gt;
 *           &lt;element name="elev" type="{https://uni-login.dk}Elev"/&gt;
 *           &lt;element name="ansat" type="{https://uni-login.dk}Ansat"/&gt;
 *           &lt;element name="ekstern" type="{https://uni-login.dk}Ekstern"/&gt;
 *         &lt;/choice&gt;
 *         &lt;element name="gruppe" type="{https://uni-login.dk}Gruppe" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
